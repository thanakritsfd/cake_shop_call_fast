          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: const Color.fromARGB(108, 255, 255, 255)),
                child: Text(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage('assets/images/${widget.cakeShop!.image1!}'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      image: DecorationImage(
                        image: AssetImage('assets/images/${widget.cakeShop!.image2!}'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      image: DecorationImage(
                        image: AssetImage('assets/images/${widget.cakeShop!.image3!}'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
              ...
              Card(
                margin: EdgeInsets.symmetric(
                  horizontal: MediaQuery.of(context).size.width * 0.1, //ซ้ายขวา
                  vertical: MediaQuery.of(context).size.width * 0.05, //บนล่าง
                ),
                child: Column(
                  children: [
